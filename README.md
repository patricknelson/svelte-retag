...
| `href`                        |     `''`     | Optional. URL(s) to your stylesheet(s). Allows you to ensure your styles are included in the shadow DOM. <br/><br/> **Note:** This option allows an array of strings for multiple stylesheets and is only useful when `shadow` is set to `true`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
